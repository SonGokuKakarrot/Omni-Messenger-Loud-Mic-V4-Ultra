# Omni Instagram Lord V4

Developed by Omni.

A Manifest V2 browser extension for Quetta/Chromium-style Android browsers that adapts the loud microphone control panel and V4 Pro WebRTC microphone pipeline for **Instagram Web voice/video calls**.
